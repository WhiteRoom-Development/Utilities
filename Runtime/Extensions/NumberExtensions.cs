...
namespace Utilities.Runtime
{
    public static class NumberExtensions
    {
...
#if ENABLED_UNITY_MATHEMATICS
        public static half AtLeast(this half value, half max) => MathUtils.Max(value, max);
        public static half AtMost(this half value, half max) => MathUtils.Min(value, max);
#endif
        ...
        public static double AtLeast(this double value, double min) => MathUtils.Max(value, min);
        public static double AtMost(this double value, double min) => MathUtils.Min(value, min);
    }
}