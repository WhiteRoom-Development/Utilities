...
namespace Utilities.Runtime
{
    ...
    {
        private static readonly int Color_KEY = Shader.PropertyToID("_Color");
        private static readonly int ZWrite_KEY = Shader.PropertyToID("_ZWrite");
        ...
        public static void EnableZWrite(this Renderer renderer)
        {
            ...
            {
                if (material.HasProperty(Color_KEY))
                {
                    material.SetInt(ZWrite_KEY, 1);
