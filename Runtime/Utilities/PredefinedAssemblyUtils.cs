...
namespace Utilities.Runtime
{
    ...
    public static class PredefinedAssemblyUtil
    {
        ...
        private static AssemblyType? GetAssemblyType(string assemblyName)
        {
            ...
            {
                "Core.Runtime" => AssemblyType.Runtime,
        ...
        public static List<Type> GetTypes(Type interfaceType)
        {
            ...
            assemblyTypes.TryGetValue(AssemblyType.Runtime, out var assemblyRuntimeTypes);
            AddTypesFromAssembly(assemblyRuntimeTypes, interfaceType, types);
